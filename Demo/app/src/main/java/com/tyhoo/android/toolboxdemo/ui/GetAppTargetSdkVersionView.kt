 ...
 */
@Composable
fun GetAppTargetSdkVersionView() {
        ...
        Button(
            onClick = {
                searchResultText = if (searchText.isEmpty()) {
                    ...
                    AppUtils.getAppTargetSdkVersion(context, searchText).toString()
                }
            }, modifier = Modifier
                .padding(top = 8.dp)
...
@Preview
@Composable
fun PreviewGetAppTargetSdkVersionView() {
    GetAppTargetSdkVersionView()
}